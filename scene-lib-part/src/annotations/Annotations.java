...
public abstract class Annotations {
     ...
     * passing to an {@link annotations.AnnotationBuilder} created by <code>af</code>.
     * Conversion is only necessary if <code>x</code> is a subannotation, in
     * which case we rebuild it with <code>af</code> since
     * {@link annotations.AnnotationBuilder#addScalarField addScalarField} of an
     * {@link annotations.AnnotationBuilder} created by <code>af</code> only accepts
     ...
     * definition and getting the values with {@link annotations.Annotation#getFieldValue}.
