...
// * the annotations to an {@link annotations.el.AScene}, using the scene's
// * {@link annotations.AnnotationFactory} to build individual annotations.
// * If the scene's {@link annotations.AnnotationFactory} announces that it does not want an
...
//            String pp = IOUtils.packagePart(className), bp = IOUtils.basenamePart(className);
//            nextLine();
