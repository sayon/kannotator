...
public final /*@ReadOnly*/ class AnnotationDef extends AElement {
     ...
     * {@linkplain java.util.Collections#unmodifiableMap unmodifiable map} to protect the
     ...
     * {@linkplain annotations.field.AnnotationFieldType#unify unifies the field types}
     * to handle arrays of unknown element type, which can arise via
     * {@link annotations.AnnotationBuilder#addEmptyArrayField}.
     */
