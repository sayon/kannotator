...
public class AnnotationBuilder {
     ...
     * of the array must be passed to the returned {@link annotations.ArrayBuilder} in
     * order, and the {@link annotations.ArrayBuilder} must be finished before any other
     * methods on this {@link AnnotationBuilder} are called.
     * <code>aft.{@link annotations.field.ArrayAFT#elementType elementType}</code> must be known
     * (not <code>null</code>).
     *
     * <p>
     * Each field may be supplied only once. This method may throw an exception
     ...
     * field type of this array is represented by an {@link annotations.field.ArrayAFT} with
     * {@link annotations.field.ArrayAFT#elementType elementType} == <code>null</code>.
     *
     * <p>
